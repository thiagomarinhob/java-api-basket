...
public interface TeamAPI {
    ...
    @GetMapping
    @Operation(summary = "Lista todos os times", description = "Retorna uma lista paginada de todos os times cadastrados no sistema, incluindo suas categorias. Use os parâmetros 'page' (começando em 0) e 'size' para navegar.")
    @ApiResponses(value = {
